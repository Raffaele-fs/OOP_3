...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        myFirstMap.put(1, "primo");
        myFirstMap.put(2, "secondo");
        myFirstMap.put(3, "terzo");
    ...
    private static void exercise2() {
        ...
        double mostExpensiveMenuItemNameNumber= 0;
        for(Map.Entry<String, Double> entry : menuCostsInEuro.entrySet()) {
        if (mostExpensiveMenuItemNameNumber < entry.getValue()){
            mostExpensiveMenuItemName=entry.getKey();
            mostExpensiveMenuItemNameNumber=entry.getValue();
        }
        }
    ...
    private static void exercise3() {
        ...
        for (Map.Entry<String, Integer> weight : fruitWeights.entrySet()) {
            totalWeight=weight.getValue()+totalWeight;
        }
        // Your code
