...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        if (ourSet.containsAll(Set.of(1, 5, 2))) {//ci dava  errore essendo un set che conteneva piu numeri uguali
    ...
    private static void exercise2() {
        ...
        //2b. What will this output? [apple, banana, orange, kiwi, pear, mango, grapes]
        System.out.println(fruitsSet);
    }
    ...
    private static void exercise4() {
        ...
        int min = Integer.MAX_VALUE;
        // Your code
        for (int numbers:orderedNumbers) {
            if (numbers==1){
                min=numbers;
                break;
            }
