...
public class Exercises {
    ...
    private final static int WEEK_IN_YEAR=52;

    private final static int DAY_IN_YEAR=52;

    private final static int HOUR_IN_YEAR=52;
    public static void exercise4() {
        System.out.println("\nExercise 4:");
        for (int week = 0; week < WEEK_IN_YEAR; week++) {
            for (int day = 0; day < DAY_IN_YEAR; day++) {
                for (int hour = 0; hour < HOUR_IN_YEAR; hour++) {
