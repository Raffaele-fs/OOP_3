...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        Circle circle=new Circle(rectangle.getHeight(), rectangle.getWidth());
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3: ");
        Piano piano=new Piano("forte","rockstar",true);
        System.out.println(piano.getName()+" "+piano.getBrand()+" "+piano.play());

        Guitar guitar=new Guitar("country","rockstar",false);

        System.out.println(guitar.getName()+" "+guitar.getBrand()+" "+guitar.play());
